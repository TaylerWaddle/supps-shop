  ...
  return (
    <div className="font-mont relative h-full w-full">
      ...
      <div className="mx-auto flex flex-col bg-zinc-900 xl:flex-row xl:items-center xl:justify-between">
        <div className="z-10 flex h-fit min-h-screen w-full flex-col items-center justify-center -space-y-[45px] pb-12 md:-space-y-[115px] xl:ml-32 xl:mt-20 xl:items-start">
          <h1 className="text-7xl font-normal text-yellow-500/85 md:text-[200px]">
            PURE
          </h1>
          <h1 className="text-7xl font-normal text-yellow-500/85 md:text-[210px]">
            APEX
          </h1>
          <span className="pt-4 text-center text-[22px] font-normal text-yellow-500/85 md:pt-10 md:text-[48px]">
            POWER SUPPLEMENTS
          </span>
        </div>
        <div className="relative z-10 flex w-full items-center justify-center xl:mt-40">
          <div className="mx-8 mb-16 flex h-fit w-fit flex-col items-center justify-center space-y-4 rounded-xl bg-zinc-950/80 px-6 py-6 text-white ring-1 ring-yellow-500 xl:mx-0 xl:px-10 xl:py-16">
            <div className="max-w-[480px]">
              <h1 className="text-center text-2xl font-light sm:text-4xl">
